<div>
    <div class="my-8 p-6 bg-white shadow-xl rounded-xl">
                ...
                <tbody>
                    @foreach ($product_colors as $product_color)
                        <tr wire:key="$product_color-{{ $product_color->pivot->id }}">
                            <td class="capitalize px-4 py-2">{{ $colors->find($product_color->pivot->color_id)->name }}</td>
                            <td class="px-4 py-2">{{ $product_color->pivot->quantity }} units</td>
