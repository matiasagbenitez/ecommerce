                    ...
                    @foreach ($product->image as $image)
                        <li class="relative" wire:key="image-{{ $image->id }}">
                            <img class="w-32 h-20 object-cover object-center"
                                src="{{ asset('storage/' . $image->url) }}" alt="Product image">
                            <x-jet-danger-button wire:click="deleteImage({{ $image->id }})"
                                wire:loading.attr="disabled" wire:target="deleteImage"
        ...
        <div class="bg-white shadow-xl p-6 rounded-lg">
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <x-jet-input wire:model="product.name" type="text" placeholder="Product name..."
                        class="w-full" />
                ...
                <div class="col-span-2">
                    ...
                    <x-jet-input wire:model="slug" type="text" placeholder="Product slug..."
                ...
                <div class="col-span-2">
                    <div wire:ignore>
                        ...
                        <textarea x-ref="miEditor" wire:model="product.description" class="w-full input-control" rows="6" x-data
    ...
    <div class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <h1 class="font-semibold text-lg text-gray-700 leading-tight">Delete product</h1>
