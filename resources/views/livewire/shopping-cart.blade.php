        ...
        <section class="bg-white rounded-lg shadow-lg p-4 text-gray-700 mb-4">
            ...
            @if (Cart::count())
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            <th class="px-14 md:px-0">Product</th>
                            <th class="px-14 md:px-0">Unitary price</th>
                            <th class="px-14 md:px-0">Quantity</th>
                            <th class="px-14 md:px-0">Subtotal</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <img class="h-14 w-14 object-cover object-center mr-3"
            ...
            @else
                <div class="text-center font-semibold text-gray-700 pt-4">
                ...
                <div>
                    <a href="{{ route('orders.create') }}">
                        <x-jet-secondary-button
                            class="bg-orange-500 border-orange-500 text-white hover:bg-orange-600 hover:text-white">
                            Continue
                        </x-jet-secondary-button>
                    </a>
                </div>
