<x-app-layout>
    ...
    <div class="container my-4">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-5 gap-5 text-white">
            ...
            <a href="{{ route('orders.index') . "?status=2" }}" class="bg-gray-500 bg-opacity-75 rounded-lg p-6 hover:cursor-pointer">
            ...
            <a href="{{ route('orders.index') . "?status=3" }}" class="bg-yellow-500 bg-opacity-75 rounded-lg p-6 hover:cursor-pointer">
            ...
            <a href="{{ route('orders.index') . "?status=4" }}" class="bg-indigo-500 bg-opacity-75 rounded-lg p-6 hover:cursor-pointer">
            ...
            <a href="{{ route('orders.index') . "?status=5" }}" class="bg-green-500 bg-opacity-75 rounded-lg p-6 hover:cursor-pointer">
